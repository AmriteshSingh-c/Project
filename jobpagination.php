...
$sql1 = "SELECT * FROM job_post LIMIT $start_from, $limit";
        ...
        <div class="attachment-block clearfix">
          ...
          <div class="attachment-pushed">
            <h4 class="attachment-heading"><a
                href="view-job-post.php?id=<?php echo $row1['id_jobpost']; ?>&active=<?php echo $row1['active'] ?>"><?php echo $row1['companyname']; ?></a> <span class="attachment-heading pull-right">₹

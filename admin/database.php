                                                ...
                                                <tbody>
                                                    ...
                                                    // selecting student record via option 
                                                        ...
                                                        if (isset($_POST['company'])) {
                                                            $company_condition = "inner join apply_job_post on users.id_user = apply_job_post.id_user where id_jobpost = (SELECT id_jobpost from job_post where companyname = '$company_option')";
                                                            $final_sql = $final_sql . $company_condition;
                                                        }

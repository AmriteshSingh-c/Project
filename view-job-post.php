                  ...
                  <?php
                    ...
                    <div>
                      <?php
                            if ($_GET['active'] == 1) {
                              ?>
                              <a  href="apply.php?id=<?php echo $row['id_jobpost']; ?>&active=<?php echo $_GET['active'] ?>"
                                class="btn btn-success btn-flat margin-top-50">Apply</a>
                        <?php
                            } else if ($_GET['active'] == 0) {
                              ?>
                                  <h3 class="text-green margin-top-50">Drive Completed</h3>
                                <?php
                            } else {
                              ?>
                                  <h3 class="text-red margin-top-50">Drive On Hold</h3>
                                <?php
                            }
                            ?>
                    </div>
